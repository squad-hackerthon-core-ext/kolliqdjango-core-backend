...
class WithdrawalRequestView(APIView):
    """
    POST /wallets/withdraw/   — request a withdrawal
    GET  /wallets/withdraw/   — list withdrawal history
    Minimum: ₦2,500. Wallet debited immediately, status starts PENDING.
    Admin approves → PROCESSING. No Squad call in simulated mode.
    """
    permission_classes = [IsAuthenticated]
